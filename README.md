...
* *MachineLearning.ipynb* contains the extraction of all features except K-means clustering, as well as the training and evaluation of machine learning algorithms. The codes for producing
...
Experimental findings were visualised using Python and Tableau. 
...
* *Figures_6_7.ipynb* contains the Python codes for creating Figure 6 (polar scatter plot in HSV space), 7(b) (scatter plot of RGB values of all pixels in an Alexandrite image), (e) (RGB histogram), (f) (HSV histogram) and (g) (CIELAB histogram).
...
All figures used in the paper can be downloaded from the subfolder 'figures'.
